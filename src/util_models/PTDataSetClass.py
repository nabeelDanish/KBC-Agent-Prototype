"""
  ...
  PTDataSetClass - a generic class for storing a dataset
  - Interoperable with PyTorch models since it returns data by batch encoding it seamlessly
  - Especially useful since several models used by MUKALMA are PyTorch models

  Credits: https://github.com/Shivanandroy/T5-Finetuning-PyTorch
  - This class is equivalent to this repository's YourDataSetClass defined in notebook/T5_Fine_tuning_with_PyTorch.ipynb
"""
